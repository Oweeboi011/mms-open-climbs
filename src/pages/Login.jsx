...
function isInAppBrowser() {
  ...
  return (
    /FBAN|FBAV|Instagram|Line\/|WhatsApp|Messenger|MicroMessenger|GSA|DuckDuckGo|Snapchat|TikTok/.test(
      ua,
    ) ||
        ...
        <div className="auth-card">
          ...
          {inAppBrowser && (
            ...
            >
              ...
              <br />
              Tap the <strong>...</strong> or <strong>share</strong> icon and
              choose "Open in Browser" (Chrome / Safari). Email sign-in still
              works here.
            </div>
          )}
          ...
          <button
            ...
            title={
              inAppBrowser
                ? "Open in your browser to use Google Sign-In"
                : undefined
            }
            style={
              inAppBrowser

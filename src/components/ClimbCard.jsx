...
const BADGE_CLASS = { minor: 'badge-minor', major: 'badge-major', special: 'badge-special' };
    ...
    >
      <div className={`card ${climb.color || 'c-slate'}`}>
        <div>
          ...
          {(climb.elevation || climb.difficulty || climb.roundTripDistance) && (
            <div className="card-stats">
              ...
              {climb.difficulty && (
                <span className="card-stat">&#9889; {climb.difficulty}</span>
              )}
          ...
          {isFull && (
            <span className="card-seats-tag" style={{ marginLeft: 4 }}>&#128683; Full</span>
          )}
          {isLow && !isFull && (
        ...
        <div className="card-footer">
          <span className={`card-badge ${BADGE_CLASS[climb.type] || 'badge-minor'}`}>
